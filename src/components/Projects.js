  ...
  return (
    <section id="projects" className="py-10 bg-teal-50 text-center">
      ...
      <div className="flex overflow-x-scroll space-x-4 p-4">
        <a href="https://github.com/anagha-h/Chat-with-PDFs" className="min-w-[300px] bg-white shadow-lg rounded-lg p-6 hover:bg-teal-100 transition">
        ...
        <a href="https://github.com/anagha-h/Automated-Essay-Scoring-System" className="min-w-[300px] bg-white shadow-lg rounded-lg p-6 hover:bg-teal-100 transition">
        ...
        <a href="https://github.com/anagha-h/resume_parser_role_recommender" className="min-w-[300px] bg-white shadow-lg rounded-lg p-6 hover:bg-teal-100 transition">
        ...
        <a href="https://github.com/anagha-h/Credit-Card-Fraud-Detection" className="min-w-[300px] bg-white shadow-lg rounded-lg p-6 hover:bg-teal-100 transition">
